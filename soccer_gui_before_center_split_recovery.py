...
MATCHES = [
    {
        "id": 1, "country": "England", "league": "Premier League",
        "tournament": "Premier League", "status": "LIVE", "minute": 67,
        "home": "Man City", "away": "Liverpool",
        "home_score": 1, "away_score": 1, "edge": -0.2,
        "odds": (1.94, 6.50, 4.50), "pred": (30, 25, 45),
        "date": "Saturday, 11 April 2026", "venue": "Etihad Stadium",
        "referee": "Michael Oliver",
        "home_form": ["W","W","L","D","W"], "away_form": ["W","L","W","W","D"],
        "home_avg": 2.1, "away_avg": 1.8,
        "draw_price": 40.0, "under_price": 45.0, "over_price": 60.0,
        "home_id": 50, "away_id": 40, "fixture_id": 1208109,
    },
    {
        "id": 2, "country": "England", "league": "Premier League",
        "tournament": "Premier League", "status": "LIVE", "minute": 45,
        "home": "Arsenal", "away": "Chelsea",
        "home_score": 1, "away_score": 0, "edge": 5.7,
        "odds": (1.80, 3.30, 6.00), "pred": (29, 31, 40),
        "date": "Saturday, 11 April 2026", "venue": "Emirates Stadium",
        "referee": "Anthony Taylor",
        "home_form": ["W","D","W","W","L"], "away_form": ["L","W","D","W","W"],
        "home_avg": 1.9, "away_avg": 1.4,
        "draw_price": 36.0, "under_price": 52.0, "over_price": 49.0,
        "home_id": 42, "away_id": 49, "fixture_id": 1208110,
    },
    {
        "id": 3, "country": "England", "league": "Premier League",
        "tournament": "Premier League", "status": "UP", "minute": 0,
        "home": "Man United", "away": "Newcastle",
        "home_score": 0, "away_score": 0, "edge": 2.8,
        "odds": (4.70, 3.90, 4.00), "pred": (25, 30, 20),
        "date": "Saturday, 11 April 2026", "venue": "Old Trafford",
        "referee": "Paul Tierney",
        "home_form": ["D","W","L","W","D"], "away_form": ["W","W","D","L","W"],
        "home_avg": 1.6, "away_avg": 1.5,
        "draw_price": 39.0, "under_price": 55.0, "over_price": 44.0,
        "home_id": 33, "away_id": 34, "fixture_id": 1208111,
    },
    {
        "id": 4, "country": "Spain", "league": "La Liga",
        "tournament": "La Liga", "status": "UP", "minute": 0,
        "home": "Real Madrid", "away": "Barcelona",
        "home_score": 0, "away_score": 0, "edge": -3.1,
        "odds": (2.80, 4.60, 5.80), "pred": (28, 32, 20),
        "date": "Saturday, 11 April 2026", "venue": "Santiago Bernabeu",
        "referee": "Jose Sanchez",
        "home_form": ["W","W","W","D","L"], "away_form": ["W","L","W","W","W"],
        "home_avg": 2.3, "away_avg": 2.0,
        "draw_price": 42.0, "under_price": 48.0, "over_price": 54.0,
        "home_id": 541, "away_id": 529, "fixture_id": 1208112,
    },
    {
        "id": 5, "country": "Spain", "league": "La Liga",
        "tournament": "La Liga", "status": "UP", "minute": 0,
        "home": "Atletico M", "away": "Sevilla",
        "home_score": 0, "away_score": 0, "edge": 3.9,
        "odds": (1.40, 5.00, 5.80), "pred": (24, 30, 18),
        "date": "Saturday, 11 April 2026", "venue": "Metropolitano",
        "referee": "Alejandro Hernandez",
        "home_form": ["W","D","W","L","W"], "away_form": ["D","L","W","D","L"],
        "home_avg": 1.7, "away_avg": 1.1,
        "draw_price": 38.0, "under_price": 58.0, "over_price": 42.0,
        "home_id": 530, "away_id": 536, "fixture_id": 1208113,
    },
    {
        "id": 6, "country": "Italy", "league": "Serie A",
        "tournament": "Serie A", "status": "UP", "minute": 0,
        "home": "Juventus", "away": "AC Milan",
        "home_score": 0, "away_score": 0, "edge": 6.8,
        "odds": (2.00, 3.90, 7.20), "pred": (18, 30, 20),
        "date": "Saturday, 11 April 2026", "venue": "Allianz Stadium",
        "referee": "Daniele Orsato",
        "home_form": ["W","W","D","W","W"], "away_form": ["L","W","D","W","D"],
        "home_avg": 1.8, "away_avg": 1.3,
        "draw_price": 35.0, "under_price": 60.0, "over_price": 40.0,
        "home_id": 496, "away_id": 489, "fixture_id": 1208114,
    },
    {
        "id": 7, "country": "Italy", "league": "Serie A",
        "tournament": "Serie A", "status": "UP", "minute": 0,
        "home": "Inter Milan", "away": "Napoli",
        "home_score": 0, "away_score": 0, "edge": 8.7,
        "odds": (1.70, 4.60, 7.80), "pred": (14, 18, 8),
        "date": "Saturday, 11 April 2026", "venue": "San Siro",
        "referee": "Marco Guida",
        "home_form": ["W","W","W","D","W"], "away_form": ["W","D","L","W","L"],
        "home_avg": 2.2, "away_avg": 1.4,
        "draw_price": 37.0, "under_price": 50.0, "over_price": 51.0,
        "home_id": 505, "away_id": 492, "fixture_id": 1208115,
    },
    {
        "id": 8, "country": "Germany", "league": "Bundesliga",
        "tournament": "Bundesliga", "status": "UP", "minute": 0,
        "home": "Bayern Mun", "away": "Dortmund",
        "home_score": 0, "away_score": 0, "edge": -3.5,
        "odds": (1.75, 5.40, 6.50), "pred": (20, 15, 34),
        "date": "Saturday, 11 April 2026", "venue": "Allianz Arena",
        "referee": "Felix Zwayer",
        "home_form": ["W","W","L","W","W"], "away_form": ["D","W","W","L","W"],
        "home_avg": 2.6, "away_avg": 1.9,
        "draw_price": 34.0, "under_price": 44.0, "over_price": 62.0,
...
ALL_COUNTRIES = ["Argentina","Australia","Austria","Belgium","Brazil","Chile",
...
ALL_LEAGUES = ["2. Bundesliga","A-League","Allsvenskan","Belgian Pro League",
...
COUNTRY_LEAGUES = {
    "England":["Premier League","Championship","EFL League One","EFL League Two","FA Cup","EFL Cup","National League"],
    "Germany":["Bundesliga","2. Bundesliga","3. Liga","DFB Pokal","Regionalliga"],
    "Spain":["La Liga","Segunda Division","Copa del Rey","Primera Federacion"],
    "Italy":["Serie A","Serie B","Serie C","Coppa Italia"],
    "France":["Ligue 1","Ligue 2","Coupe de France","National"],
    "United States":["MLS","USL Championship","US Open Cup","NWSL"],
}
MAIN_TOURNAMENTS = ["Premier League","Champions League","Europa League","FA Cup",
    "Copa del Rey","Coppa Italia","DFB Pokal","Copa Libertadores","World Cup Qualifiers"]
...
class SoccerEdgeApp:
        ...
        try:
            while True:
                ...
                if event_type == "live_matches":
                    self._ingest_live_matches(data)
                elif event_type == "today_matches":
                    self._ingest_today_matches(data)
                elif event_type == "error":
                    if self.status_label:
                        self.status_label.config(
                            text=f"API error: {str(data)[:80]}", fg=RED)
        except queue.Empty:
            pass
        self.root.after(500, self._process_poll_queue)

    def _ingest_live_matches(self, api_matches):
        if not api_matches:
            return
        global MATCHES
        ...
        for m in api_matches:
            ...
            if not fid:
                continue
            status = m.get("status","")
            gui_status = "LIVE" if status in ("1H","2H","HT","ET","P","LIVE") else status
            entry = {
                "id": fid, "country": m.get("country",""),
                "league": m.get("league",""), "tournament": m.get("league",""),
                "status": gui_status, "minute": int(m.get("minute") or 0),
        ...
        if self.status_label:
            self.status_label.config(
                text=f"Last Load: live API  |  Matches: {len(MATCHES)}  |  Live: {live_count}",
                fg=GREEN)
        self.render_matches()

    def _ingest_today_matches(self, api_matches):
        global MATCHES
        existing_ids = {m["id"] for m in MATCHES}
        added = 0
        for m in api_matches:
            ...
            MATCHES.append({
                ...
                "status": "UP", "minute": 0,
                "home": m["home"], "away": m["away"],
                "home_score": 0, "away_score": 0, "edge": 0.0,
                "odds": (2.0,3.5,4.0), "pred": (33,33,34),
                "date": m.get("date","")[:10], "venue": m.get("venue",""),
                "referee": m.get("referee","") or "",
                "home_form": ["?","?","?","?","?"],
                "away_form": ["?","?","?","?","?"],
    ...
    def _fetch_today_now(self):
        try:
            from live_data import fetch_matches_by_date, today_str, shift_date_str
            today = today_str()
            for offset in [-1, 0, 1]:
                matches = fetch_matches_by_date(shift_date_str(today, offset))
                if matches:
                    self.poll_queue.put(("today_matches", matches))
        except Exception as e:
            self.poll_queue.put(("error", f"today fetch: {e}"))
    ...
    def _run_live_analysis(self, match):
        try:
            ...
            if result:
                self.root.after(0, lambda: self._apply_live_result(match, result))
        except Exception as e:
            print(f"[analysis] {e}")

    def _apply_live_result(self, match, result):
        if self.current_match["id"] != match["id"]:
            return
        match["edge"] = round(result.best_edge, 1)
        home_xg, away_xg = result.probabilities.get("xg", (0.0, 0.0))
        match["home_avg"] = round(home_xg, 2)
        match["away_avg"] = round(away_xg, 2)
        ...
        if self.tracker_status:
            self.tracker_status.config(
                text=f"Live: {result.best_pick}  |  edge {result.best_edge:+.1f}  |  confidence {conf_pct}%  |  {len(result.warnings)} warning(s)",
                fg=CYAN)
    ...
    def build_ui(self):
        ...
        tk.Label(topbar, text="SOCCER EDGE ENGINE", bg=TOP, fg="#7dd3fc",
            font=("Consolas", 18, "bold"), anchor="w").pack(side="left", padx=8)
        tk.Button(topbar, text="Test Speed", bg="#334155", fg=TEXT,
            activebackground="#475569", activeforeground=TEXT,
            relief="flat", font=FONT_SMALL, padx=12,
            command=self.test_speed).pack(side="right", padx=14)
    ...
    def build_left(self, parent):
        ...
        self.status_label = tk.Label(parent,
            ...
            bg=PANEL, fg=MUTED, font=FONT_MONO_SMALL, anchor="w", padx=8)
        ...
        self.live_api_btn = tk.Button(parent,
            text="Switch to Live API",
            bg="#5fa8d3", fg=TEXT,
            activebackground="#72b8df", activeforeground=TEXT,
            relief="flat", font=FONT_BOLD, pady=5,
            command=self.switch_live_api)
        self.live_api_btn.grid(row=2, column=0, sticky="ew", pady=(0,8))
    ...
    def switch_live_api(self):
        if self.live_api_active:
            self.poller.stop()
            self.live_api_active = False
            self.live_api_btn.config(text="Switch to Live API", bg="#5fa8d3")
            self.status_label.config(
                text="Live API stopped. Showing local mock data.", fg=MUTED)
        else:
            self.poller.start()
            self.live_api_active = True
            self.live_api_btn.config(text="Stop Live API  [LIVE]", bg=GREEN_DARK)
            self.status_label.config(
                text="Live API started — polling every 15s...", fg=GREEN)
            threading.Thread(target=self._fetch_today_now, daemon=True).start()
    ...
    def add_filter(self, parent, title, key, values, height=8):
        ...
        tk.Label(frame, text=title, bg=PANEL, fg=CYAN,
            font=FONT_SMALL, anchor="w").pack(fill="x")
        combo = ttk.Combobox(frame, textvariable=self.filters[key],
            values=values, state="readonly", style="Dark.TCombobox",
            height=height, font=FONT_SMALL)
        combo.pack(fill="x", pady=(2,0))
        combo.bind("<<ComboboxSelected>>",
            lambda _e, item=key: self.on_filter_change(item))
    ...
    def create_matches_scroller(self, parent):
        ...
        self.matches_frame.bind("<Configure>", lambda _e: self.matches_canvas.configure(scrollregion=self.matches_canvas.bbox("all")))
        self.matches_canvas.bind("<Configure>", lambda e: self.matches_canvas.itemconfigure(window_id, width=e.width))
    ...
    def create_watchlist_scroller(self, parent):
        ...
        self.watchlist_frame.bind("<Configure>", lambda _e: self.watchlist_canvas.configure(scrollregion=self.watchlist_canvas.bbox("all")))
        self.watchlist_canvas.bind("<Configure>", lambda e: self.watchlist_canvas.itemconfigure(window_id, width=e.width))

    def build_center(self, parent):
        parent.grid_rowconfigure(1, weight=1)
        parent.grid_columnconfigure(0, weight=1)
        tk.Label(parent, text="MATCH ANALYSIS", bg=BG, fg=CYAN,
            font=FONT_BOLD, anchor="w").grid(row=0, column=0, sticky="ew", pady=(8,6))
        self.center_split = tk.PanedWindow(parent, orient="vertical", bg=BG,
            sashwidth=8, sashrelief="raised", showhandle=True, opaqueresize=True)
    ...
    def build_scoreboard(self, parent):
        ...
        self.score_labels["home_badge"] = tk.Label(home_box, text="", bg="#facc15",
            fg="#111827", font=("Segoe UI",12,"bold"), width=4, pady=5)
        self.score_labels["home_badge"].pack(pady=(0,4))
        self.score_labels["home"] = tk.Label(home_box, text="", bg=PANEL, fg=TEXT,
            font=("Segoe UI",12,"bold"))
        self.score_labels["home"].pack()
        self.score_labels["home_form"] = tk.Label(home_box, text="", bg=PANEL,
            fg=MUTED, font=FONT_SMALL)
        self.score_labels["home_form"].pack()
        self.score_labels["home_goals"] = tk.Label(home_box, text="", bg=PANEL,
            fg=MUTED, font=FONT_SMALL)
        ...
        self.score_labels["home_score"] = tk.Label(line, text="0", bg=PANEL,
            fg=ORANGE, font=("Consolas",22,"bold"))
        ...
        self.score_labels["minute"] = tk.Label(center, text="00'", bg=PANEL,
            fg=CYAN, font=FONT_MONO_SMALL)
        self.score_labels["minute"].pack()
        self.score_labels["status"] = tk.Label(center, text="LIVE", bg=PANEL,
            fg=GREEN, font=FONT_SMALL)
        self.score_labels["status"].pack()
        self.score_labels["edge"] = tk.Label(center, text="+0.0", bg=PANEL_DARK,
            fg=TEXT, font=FONT_MONO_SMALL, padx=10, pady=3)
        self.score_labels["edge"].pack(pady=(5,0))
        self.score_labels["replay_state"] = tk.Label(center, text="", bg=PANEL,
            fg=MUTED, font=FONT_SMALL)
        ...
        self.score_labels["away_badge"] = tk.Label(away_box, text="", bg="#ef4444",
            fg=TEXT, font=("Segoe UI",12,"bold"), width=4, pady=5)
        self.score_labels["away_badge"].pack(pady=(0,4))
        self.score_labels["away"] = tk.Label(away_box, text="", bg=PANEL, fg=TEXT,
            font=("Segoe UI",12,"bold"))
        self.score_labels["away"].pack()
        self.score_labels["away_form"] = tk.Label(away_box, text="", bg=PANEL,
            fg=MUTED, font=FONT_SMALL)
        self.score_labels["away_form"].pack()
        self.score_labels["away_goals"] = tk.Label(away_box, text="", bg=PANEL,
            fg=MUTED, font=FONT_SMALL)
    ...
    def meta_pair(self, parent, col, title):
        ...
        tk.Label(frame, text=f"{title}:", bg=PANEL_DARK, fg=CYAN,
            font=FONT_SMALL, anchor="w").pack(side="left")
        label = tk.Label(frame, text="", bg=PANEL_DARK, fg=MUTED,
    ...
    def build_action_bar(self, parent):
        ...
        ask_wrap = tk.Frame(center, bg="#243244",
            highlightbackground=BORDER, highlightthickness=1)
        ask_wrap.grid(row=0, column=0, sticky="ew")
        tk.Label(ask_wrap, text="Quick Find", bg="#243244", fg=CYAN,
            font=FONT_BOLD, padx=10).pack(side="left")
        entry = tk.Entry(ask_wrap, textvariable=self.quick_query,
            bg="#0f172a", fg=TEXT, insertbackground=TEXT,
            relief="flat", font=FONT_SMALL)
        entry.pack(side="left", fill="x", expand=True, padx=(0,6), pady=7)
        entry.bind("<Return>", lambda _e: self.quick_find())
        ...
        tk.Label(center,
            ...
            bg=BG, fg=MUTED, font=FONT_SMALL, anchor="w").grid(row=1,column=0,sticky="ew",pady=(4,0))
        ...
        self.tracker_status = tk.Label(parent, text="", bg=PANEL,
    ...
    def build_right(self, parent):
        parent.grid_columnconfigure(0, weight=1)
        for i, w in enumerate([3,2,1,2,2,2]):
            parent.grid_rowconfigure(i, weight=w)
    ...
    def panel(self, parent, title):
        ...
        tk.Label(outer, text=title, bg=BG, fg=CYAN, font=FONT_BOLD,
            anchor="w", padx=8, pady=5).grid(row=0, column=0, sticky="ew")
    ...
    def button(self, parent, text, bg, command, width=None, pady=6):
        return tk.Button(parent, text=text, bg=bg, fg=TEXT,
            ...
            padx=10, pady=pady, width=width, command=command)

    # -------------------------
    # FIXED filtered_matches
    # -------------------------
    ...
    def filtered_matches(self):
        ...
        for match in MATCHES:
            if country != "All" and match.get("country","") != country:
                continue
            if league != "All" and match.get("league","") != league:
                continue
            if tournament != "All" and match.get("tournament","") != tournament:
                continue
            status = match.get("status","")
            if date_filter == "Live" and status not in ("LIVE","1H","2H","HT","ET","P"):
                continue
            if date_filter == "Upcoming" and status in ("LIVE","1H","2H","HT","ET","P"):
                continue
            items.append(match)
        return items
    ...
    def render_matches(self):
        ...
        live_count = sum(1 for m in matches if m.get("status") == "LIVE")
        self.status_label.config(
            text=f"Last Load: {src}  |  Matches: {len(matches)}  |  Live: {live_count}")
        grouped = {}
        for match in matches:
            grouped.setdefault(match.get("league","Unknown"), []).append(match)
        if not matches:
            tk.Label(self.matches_frame,
                text="No matches for selected filters.",
                bg=PANEL_DARK, fg=MUTED, font=FONT_MONO, pady=20).pack(fill="x")
            return
        for league, league_matches in grouped.items():
            tk.Label(self.matches_frame,
                text=f"--- {league.upper()} ---",
                bg="#111827", fg=TEXT, font=FONT_MONO_SMALL, pady=3).pack(fill="x",padx=4,pady=(4,1))
            for match in league_matches:
                self.match_row(self.matches_frame, match)

    def match_row(self, parent, match):
        self.compact_match_row(parent, match,
    ...
    def compact_match_row(self, parent, match, selected=False):
        ...
        edge_color = GREEN if match.get("edge",0) >= 0 else RED
        score = f"{match.get('home_score',0)}-{match.get('away_score',0)}"
        odds = match.get("odds",(2.0,3.5,4.0))
        odds_str = f"{odds[0]:.1f}/{odds[1]:.1f}/{odds[2]:.1f}"
        pred = match.get("pred",(33,33,34))
        pred_str = f"{pred[0]:>2}/{pred[1]:>2}/{pred[2]:>2}"
        is_starred = match["id"] in self.watchlist_ids
        star = "★" if is_starred else "☆"
        values = [
            (status, 0, 4, status_color, "w"),
            (str(match.get("minute","")) if match.get("minute") else "--", 1, 4, "#60a5fa", "center"),
            (match.get("home",""), 2, 13, TEXT, "e"),
            (score, 3, 5, ORANGE, "center"),
            (match.get("away",""), 4, 13, TEXT, "w"),
            (f"{match.get('edge',0.0):+.1f}", 5, 6, edge_color, "center"),
            (odds_str, 6, 13, MUTED, "center"),
            (pred_str, 7, 9, MUTED, "center"),
        ]
        for text, col, width, color, anchor in values:
            label = tk.Label(row, text=text, bg=row_bg, fg=color,
                font=FONT_MONO_SMALL, width=width, anchor=anchor)
            label.grid(row=0, column=col, sticky="ew", padx=1, pady=5)
            label.bind("<Button-1>", lambda _e, item=match: self.select_match(item))
        star_btn = tk.Button(row, text=star, bg=row_bg,
            fg=YELLOW if is_starred else MUTED,
            activebackground=row_bg, activeforeground=YELLOW,
            relief="flat", width=2, font=("Segoe UI Symbol",11,"bold"),
            command=lambda item=match: self.toggle_watchlist(item))
        star_btn.grid(row=0, column=8, padx=(2,5))
        row.bind("<Button-1>", lambda _e, item=match: self.select_match(item))
    ...
    def select_match(self, match, refresh=True):
        ...
        self.score_labels["home_badge"].config(text=self.team_initials(match.get("home","")))
        self.score_labels["away_badge"].config(text=self.team_initials(match.get("away","")))
        self.score_labels["home"].config(text=match.get("home",""))
        self.score_labels["away"].config(text=match.get("away",""))
        self.score_labels["home_score"].config(text=str(match.get("home_score",0)))
        self.score_labels["away_score"].config(text=str(match.get("away_score",0)))
        self.score_labels["minute"].config(text=f"{match.get('minute',0):02d}'")
        status = match.get("status","UP")
        self.score_labels["status"].config(
            text=status, fg=GREEN if status == "LIVE" else YELLOW)
        edge = match.get("edge", 0.0)
        self.score_labels["edge"].config(
            text=f"{edge:+.1f}", fg=GREEN if edge >= 0 else RED)
        self.score_labels["home_form"].config(
            text="Form: " + "-".join(match.get("home_form",["?","?","?","?","?"])))
        self.score_labels["away_form"].config(
            text="Form: " + "-".join(match.get("away_form",["?","?","?","?","?"])))
        self.score_labels["home_goals"].config(
            text=f"Goals: {match.get('home_avg',0)}/game")
        self.score_labels["away_goals"].config(
            text=f"Goals: {match.get('away_avg',0)}/game")
        ...
        if match.get("fixture_id") and match.get("home_id") and self.live_api_active:
            threading.Thread(
                target=self._run_live_analysis,
                args=(match,), daemon=True).start()

    def team_initials(self, team):
        words = [p for p in str(team).replace("-"," ").split() if p]
        if not words: return "FC"
    ...
    def render_tab(self):
        ...
        if   tab == "Overview":     self.render_overview_tab(body, match)
        elif tab == "Stats Replay": self.render_stats_tab(body, match)
        elif tab == "Attack":       self.render_attack_tab(body, match)
        elif tab == "Control":      self.render_control_tab(body, match)
        elif tab == "Defense":      self.render_defense_tab(body, match)
        elif tab == "Line-ups":     self.render_lineups_tab(body, match)
        elif tab == "Chat":         self.render_chat_tab(body, match)
        elif tab == "Table":        self.render_table_tab(body, match)
        elif tab == "H2H":          self.render_h2h_tab(body, match)
    ...
    def section_title(self, parent, text):
        tk.Label(parent, text=text, bg=PANEL, fg=CYAN,
            font=FONT_BOLD, anchor="w", pady=6).pack(fill="x")

    def info_card(self, parent):
        card = tk.Frame(parent, bg=PANEL_DARK,
            highlightbackground=BORDER, highlightthickness=1)
    ...
    def render_replay_state_note(self, parent, minute, max_minute):
        tk.Label(parent,
            ...
            bg=PANEL, fg=MUTED, font=FONT_SMALL, anchor="w").pack(fill="x", pady=(0,4))
    ...
    def quick_find(self):
        ...
        if not query:
            self.tracker_status.config(
                text="Try: 35 minute shots, lineups, table, h2h, or possession.", fg=MUTED)
            return
        lower = query.lower()
        minute = None
        m = re.search(r"(\d{1,3})", lower)
        if m:
            minute = min(int(m.group(1)), self.stats_max_minute(self.current_match))
        ...
        self.tracker_status.config(text=f"Quick Find: opened {label}{minute_text}.", fg=CYAN)
    ...
    def resolve_quick_find_target(self, query):
        mappings = [
            ...
            (("possession","pass","control","territory","corner"),    "Control",      "control profile"),
            (("defense","defence","foul","card","save","offside"),    "Defense",      "defense profile"),
    ...
    def reset_replay_to_live(self):
        ...
        self.tracker_status.config(
            text=f"Replay reset to current minute {target:02d}'.", fg=GREEN)

    def draw_timeline_markers(self, canvas, match, max_minute):
        canvas.delete("all")
        width = max(canvas.winfo_width(), 10)
        left_pad, right_pad, line_y = 6, 6, 11
        canvas.create_line(left_pad, line_y, width-right_pad, line_y, fill=BORDER, width=2)
        for idx, event in enumerate(self.timeline_events(match, max_minute)):
            ...
            canvas.tag_bind(tag, "<Button-1>",
                lambda _e, mn=event["minute"]: self.jump_to_replay_minute(mn))

    def event_color(self, event_name):
        return {"GOAL":ORANGE,"CARD":YELLOW,"SUB":CYAN,"SHOT":CYAN,
                "SAVE":CYAN,"PRESS":GREEN,"VAR":PURPLE,"PEN":RED,"SCORE":MUTED}.get(event_name, CYAN)

    def render_player_panels(self, parent, context, left_title, left_rows,
                              right_title, right_rows, accent):
    ...
    def render_player_panel(self, parent, context, title, rows, accent):
        ...
        tk.Label(header, text=title, bg=PANEL_DARK, fg=TEXT,
        ...
        for detail in rows:
            ...
            badge = tk.Label(row, text=self.team_initials(name)[:2],
                bg="#243244", fg=TEXT, font=FONT_MONO_SMALL, width=4, pady=4)
            badge.pack(side="left")
            text_wrap = tk.Frame(row, bg=PANEL_DARK)
            text_wrap.pack(side="left", fill="x", expand=True, padx=(8,0))
            name_label = tk.Label(text_wrap, text=name, bg=PANEL_DARK, fg=TEXT,
                font=FONT_SMALL, anchor="w", cursor="hand2")
            name_label.pack(fill="x")
            stat_label = tk.Label(text_wrap, text=detail["summary"], bg=PANEL_DARK,
                fg=MUTED, font=FONT_SMALL, anchor="w", cursor="hand2")
            stat_label.pack(fill="x")
            arrow = tk.Label(row, text=">", bg=PANEL_DARK, fg=accent,
                font=FONT_BOLD, width=2, cursor="hand2")
            arrow.pack(side="right")
            for widget in (row, badge, text_wrap, name_label, stat_label, arrow):
                widget.bind("<Button-1>",
                    lambda _e, p=detail, s=context: self.open_player_detail(s, p))
    ...
    def render_selected_player_detail(self, parent, context):
        ...
        if not detail or detail["context"] != context:
            tk.Label(parent,
                ...
                bg=PANEL, fg=MUTED, font=FONT_SMALL, anchor="w").pack(fill="x", pady=(0,6))
            return
        card = self.info_card(parent)
        top = tk.Frame(card, bg=PANEL_DARK)
        top.pack(fill="x", padx=10, pady=(8,4))
        tk.Label(top, text=f"{detail['name']}  |  {detail['team']}",
            bg=PANEL_DARK, fg=TEXT, font=FONT_BOLD, anchor="w").pack(side="left")
        tk.Button(top, text="Close", bg="#243244", fg=TEXT,
            activebackground="#334155", activeforeground=TEXT,
            relief="flat", font=FONT_SMALL,
            command=self.close_player_detail).pack(side="right")
        tk.Label(card, text=detail["headline"], bg=PANEL_DARK, fg=MUTED,
            font=FONT_SMALL, anchor="w", padx=10, pady=2).pack(fill="x")
        ...
        tk.Label(notes, text="Why it matters", bg=PANEL_DARK, fg=CYAN,
            font=FONT_BOLD, anchor="w").pack(fill="x", pady=(0,4))
        for line in detail["notes"]:
            tk.Label(notes, text=f"+ {line}", bg=PANEL_DARK, fg=MUTED,
                font=FONT_SMALL, anchor="w", justify="left").pack(fill="x", pady=1)
    ...
    def replay_tick(self):
        ...
        if current >= self.replay_max_minute:
            self.pause_replay()
            return
        self.set_replay_minute(current + 1)
    ...
    def render_overview_tab(self, parent, match):
        ...
        values = [
            ...
            ("League Angle", f"{match.get('league','')} form + market context"),
        ]
        ...
        for minute_text, team, event, detail in self.match_events(match):
            ...
            tk.Label(row, text=minute_text, bg=PANEL_DARK, fg=MUTED,
                font=FONT_MONO_SMALL, width=8, anchor="w").pack(side="left", padx=10, pady=8)
            tk.Label(row, text=event, bg=PANEL_DARK,
                fg=ORANGE if event=="GOAL" else YELLOW if event=="CARD" else CYAN,
                font=FONT_BOLD, width=10).pack(side="left")
            tk.Label(row, text=team or "Match", bg=PANEL_DARK, fg=TEXT,
                font=FONT_BOLD, width=16, anchor="w").pack(side="left")
            tk.Label(row, text=detail, bg=PANEL_DARK, fg=MUTED,
        ...
        for label, home, away in self.match_stats_at_minute(match, minute, max_minute)[:6]:
    ...
    def render_odds_board(self, match):
        ...
        for text, width in [("BOOK",14),("HOME",7),("DRAW",7),("AWAY",7),("EDGE",7)]:
            tk.Label(header, text=text, bg=PANEL_DARK, fg=ORANGE,
                font=FONT_MONO_SMALL, width=width, anchor="w").pack(side="left")
        for book, home, draw, away, edge in self.odds_rows(match):
            ...
            for value, width, color in [
                (book,14,TEXT),(f"{home:.2f}",7,CYAN),
                (f"{draw:.2f}",7,MUTED),(f"{away:.2f}",7,ORANGE),
                (f"{edge:+.1f}",7,GREEN if edge>=0 else RED),
            ]:
                label = tk.Label(row, text=value, bg=row_bg, fg=color,
                    font=FONT_MONO_SMALL, width=width, anchor="w")
                label.pack(side="left", pady=4)
                label.bind("<Button-1>", lambda _e, b=book: self.open_odds_detail(b))
            row.bind("<Button-1>", lambda _e, b=book: self.open_odds_detail(b))
        footer = tk.Frame(self.odds_body, bg=PANEL)
        footer.pack(fill="x", padx=6, pady=(5,4))
        best = max(self.odds_rows(match), key=lambda x: x[4])
        tk.Label(footer, text=f"Best value: {best[0]}  edge {best[4]:+.1f}",
    ...
    def render_prediction_feed(self, match):
        ...
        for source, home, draw, away, pick in self.prediction_rows(match):
            ...
            row.pack(fill="x", padx=6, pady=1)
            pick_color = CYAN if pick==match.get("home") else ORANGE if pick==match.get("away") else MUTED
            for value, width, color in [
                (source,14,TEXT),(f"{home}%",7,CYAN),
                (f"{draw}%",7,MUTED),(f"{away}%",7,ORANGE),(pick[:10],10,pick_color),
            ]:
                label = tk.Label(row, text=value, bg=ROW, fg=color,
                    font=FONT_MONO_SMALL, width=width, anchor="w")
                label.pack(side="left", pady=4)
                label.bind("<Button-1>", lambda _e, s=source: self.open_prediction_detail(s))
            row.bind("<Button-1>", lambda _e, s=source: self.open_prediction_detail(s))
        consensus = self.consensus_prediction(match)
        summary = self.info_card(self.predictions_body)
        tk.Label(summary, text="CONSENSUS", bg=PANEL_DARK, fg=CYAN,
            font=FONT_BOLD, anchor="w").pack(fill="x", padx=8, pady=(6,2))
        tk.Label(summary,
            text=f"{consensus['pick']}  |  confidence {consensus['confidence']}%  |  avg {consensus['home']} / {consensus['draw']} / {consensus['away']}",
            bg=PANEL_DARK, fg=TEXT, font=FONT_SMALL, anchor="w", padx=8, pady=7).pack(fill="x")

    def render_odds_detail(self, match, book_name):
        top = tk.Frame(self.odds_body, bg=PANEL_DARK)
        top.pack(fill="x", padx=6, pady=(6,6))
        tk.Button(top, text="< Back to books", bg="#243244", fg=TEXT,
            activebackground="#334155", activeforeground=TEXT,
            relief="flat", font=FONT_SMALL,
            command=self.close_odds_detail).pack(side="left")
        tk.Label(top, text=f"{book_name} detailed markets",
            bg=PANEL_DARK, fg=ORANGE, font=FONT_BOLD).pack(side="left", padx=10)
        header = tk.Frame(self.odds_body, bg=PANEL_DARK)
        ...
        for market, left, middle, right, note in self.odds_detail_rows(match, book_name):
            ...
            row.pack(fill="x", padx=6, pady=1)
            for value, width, color in [
                (market,20,TEXT),(left,10,CYAN),(middle,10,MUTED),
                (right,10,ORANGE),(note,18,GREEN if "value" in note.lower() else MUTED),
            ]:
                tk.Label(row, text=value, bg=ROW, fg=color,
                    font=FONT_MONO_SMALL, width=width, anchor="w").pack(side="left", pady=4)

    def render_prediction_detail(self, match, source_name):
        top = tk.Frame(self.predictions_body, bg=PANEL_DARK)
        top.pack(fill="x", padx=6, pady=(6,6))
        tk.Button(top, text="< Back to sources", bg="#243244", fg=TEXT,
            activebackground="#334155", activeforeground=TEXT,
            relief="flat", font=FONT_SMALL,
            command=self.close_prediction_detail).pack(side="left")
        tk.Label(top, text=f"{source_name} prediction detail",
            bg=PANEL_DARK, fg=ORANGE, font=FONT_BOLD).pack(side="left", padx=10)
        detail = self.prediction_detail_snapshot(match, source_name)
        summary = self.info_card(self.predictions_body)
        summary.pack(fill="x", padx=6, pady=(0,6))
        tk.Label(summary, text=detail["headline"], bg=PANEL_DARK, fg=TEXT,
            font=FONT_BOLD, anchor="w").pack(fill="x", padx=10, pady=(8,3))
        tk.Label(summary,
            text=f"Confidence {detail['confidence']}%  |  {detail['model_family']}  |  {detail['updated']}",
            bg=PANEL_DARK, fg=MUTED, font=FONT_SMALL, anchor="w").pack(fill="x", padx=10, pady=(0,8))
        ...
        for label, value in detail["markets"]:
            ...
            tk.Label(row, text=label, bg=PANEL_DARK, fg=CYAN,
                font=FONT_SMALL, width=18, anchor="w").pack(side="left")
            tk.Label(row, text=value, bg=PANEL_DARK, fg=TEXT,
                font=FONT_SMALL, anchor="w").pack(side="left")
    ...
    def render_stats_tab(self, parent, match):
        ...
        for box in summary.winfo_children()[0].winfo_children():
            labels = [c for c in box.winfo_children() if isinstance(c, tk.Label)]
            if len(labels) >= 2:
        ...
        tk.Label(top, text="MATCH REPLAY", bg=PANEL_DARK, fg=CYAN,
            font=FONT_BOLD, anchor="w").pack(side="left")
        minute_label = tk.Label(top, text="", bg=PANEL_DARK, fg=ORANGE,
        ...
        slider = tk.Scale(scale_wrap, from_=0, to=max_minute, orient="horizontal",
            showvalue=False, resolution=1, bg=PANEL_DARK, fg=TEXT,
            troughcolor="#243244", highlightthickness=0,
            activebackground=ORANGE, length=520)
        ...
        tk.Label(controls,
            text="Play runs forward from the selected minute. Stop returns to where replay started.",
            bg=PANEL_DARK, fg=MUTED, font=FONT_SMALL, anchor="w").pack(side="left", fill="x", expand=True, padx=(12,0))
        ...
        markers.bind("<Configure>", lambda _e: self.draw_timeline_markers(markers, match, max_minute))
    ...
    def render_attack_tab(self, parent, match):
        ...
        self.render_player_panels(parent, "attack",
            match.get("home",""), self.attack_players(match, match.get("home",""), minute, max_minute),
            match.get("away",""), self.attack_players(match, match.get("away",""), minute, max_minute),
            ORANGE)
    ...
    def render_defense_tab(self, parent, match):
        ...
        self.render_player_panels(parent, "defense",
            match.get("home",""), self.defense_players(match, match.get("home",""), minute, max_minute),
            match.get("away",""), self.defense_players(match, match.get("away",""), minute, max_minute),
            CYAN)

    def render_replay_events(self, parent, match, minute, max_minute):
        self.clear(parent)
        self.section_title(parent, "KEY MOMENTS TO THIS MINUTE")
        shown = [e for e in self.timeline_events(match, max_minute) if e["minute"] <= minute]
        if not shown:
            tk.Label(parent,
                text="No tracked moments yet at this point in the replay.",
                bg=PANEL_DARK, fg=MUTED, font=FONT_SMALL,
                anchor="w", padx=10, pady=10).pack(fill="x")
            return
        for event in shown[-5:]:
            row = tk.Frame(parent, bg=PANEL_DARK)
            row.pack(fill="x", padx=10, pady=3)
            tk.Label(row, text=event["minute_text"], bg="#243244", fg=TEXT,
                font=FONT_MONO_SMALL, width=6, pady=4).pack(side="left")
            tk.Label(row, text=event["event"], bg=PANEL_DARK,
                fg=self.event_color(event["event"]), font=FONT_BOLD,
                width=8, anchor="w").pack(side="left", padx=(8,10))
            tk.Label(row, text=event["team"], bg=PANEL_DARK, fg=TEXT,
                font=FONT_BOLD, width=16, anchor="w").pack(side="left")
            tk.Label(row, text=event["detail"], bg=PANEL_DARK, fg=MUTED,
                font=FONT_SMALL, anchor="w").pack(side="left", fill="x", expand=True)
    ...
    def render_lineups_tab(self, parent, match):
        ...
        for label, value in [
            (match.get("home",""), self.lineup_formation(match, "home", minute)),
            ("Replay", f"{minute:02d}'"),
            (match.get("away",""), self.lineup_formation(match, "away", minute)),
        ]:
        ...
        tk.Label(notes, text="LINE-UP NOTES", bg=PANEL_DARK, fg=CYAN,
            font=FONT_BOLD, anchor="w").pack(fill="x", padx=10, pady=(8,4))
        for line in self.lineup_notes(match, minute):
            tk.Label(notes, text=f"+ {line}", bg=PANEL_DARK, fg=MUTED,
                font=FONT_SMALL, anchor="w", justify="left").pack(fill="x", padx=10, pady=2)
    ...
    def render_chat_tab(self, parent, match):
        ...
        top.pack(fill="x", padx=10, pady=(8,4))
        tk.Label(top,
            text=f"{match.get('home','')} vs {match.get('away','')}  |  dedicated room",
            bg=PANEL_DARK, fg=TEXT, font=FONT_BOLD, anchor="w").pack(side="left")
        tk.Label(top, text=f"Replay {minute:02d}'",
            bg=PANEL_DARK, fg=ORANGE, font=FONT_BOLD, anchor="e").pack(side="right")
        tk.Label(room,
            text="This thread follows the match before, during, and after kickoff.",
            bg=PANEL_DARK, fg=MUTED, font=FONT_SMALL, anchor="w",
            justify="left", padx=10, pady=2).pack(fill="x", pady=(0,8))
        ...
        for text in self.chat_rooms():
            ...
            tk.Button(rooms, text=f"{text} {count} {badge}".strip(),
                ...
                font=FONT_BOLD, padx=14, pady=6, relief="flat",
                command=lambda r=text, c=match: self.set_chat_room(c, r)).pack(side="left", padx=(0,8))
        ...
        feed_body.bind("<Configure>", lambda _e: chat_canvas.configure(scrollregion=chat_canvas.bbox("all")))
        chat_canvas.bind("<Configure>", lambda e: chat_canvas.itemconfigure(window_id, width=e.width))
        ...
        entry = tk.Entry(row, textvariable=self.chat_message,
            bg="#0f172a", fg=TEXT, insertbackground=TEXT,
            relief="flat", font=FONT_SMALL)
        entry.pack(side="left", fill="x", expand=True, padx=(0,8), ipady=7)
        entry.bind("<Return>", lambda _e, c=match: self.post_chat_message(c))
        self.button(row,"Post",CYAN_DARK,lambda c=match: self.post_chat_message(c),width=10,pady=7).pack(side="left",padx=(0,6))
        self.button(row,"Agent Note",ORANGE,lambda c=match: self.add_agent_note(c),width=12,pady=7).pack(side="left")

    def render_table_tab(self, parent, match):
        self.section_title(parent, f"{match.get('league','')} TABLE")
        table = self.info_card(parent)
        header = tk.Frame(table, bg=PANEL_DARK)
        header.pack(fill="x", padx=8, pady=(8,4))
        for text, width in [("#",4),("Team",22),("P",5),("GD",6),("PTS",6),("W",5)]:
            tk.Label(header, text=text, bg=PANEL_DARK, fg=MUTED,
                font=FONT_SMALL, width=width, anchor="w").pack(side="left")
        for pos, team, played, gd, pts, wins in self.table_rows(match):
            active = team in (match.get("home",""), match.get("away",""))
            row = tk.Frame(table, bg="#263244" if active else PANEL_DARK)
            row.pack(fill="x", padx=8, pady=1)
            color = ORANGE if active else TEXT
            for text, width, fg in [
                (str(pos),4,MUTED),(team,22,color),(str(played),5,MUTED),
                (f"{gd:+}",6,MUTED),(str(pts),6,TEXT),(str(wins),5,MUTED),
            ]:
                tk.Label(row, text=text, bg=row.cget("bg"),
                    fg=fg, font=FONT_BOLD if active else FONT_SMALL,
                    width=width, anchor="w").pack(side="left", pady=5)

    def render_h2h_tab(self, parent, match):
        self.section_title(parent, "HEAD TO HEAD")
        filters = tk.Frame(parent, bg=PANEL)
        filters.pack(fill="x", pady=(0,8))
        for text, active in [("H2H",True),(match.get("home",""),False),(match.get("away",""),False)]:
            tk.Label(filters, text=text,
                bg=TEXT if active else PANEL_DARK,
                fg=BG if active else MUTED,
                font=FONT_BOLD, padx=14, pady=6).pack(side="left", padx=(0,8))
        for season, home, away, home_score, away_score in self.h2h_rows(match):
            card = self.info_card(parent)
            tk.Label(card, text=season, bg=PANEL_DARK, fg=CYAN,
                font=FONT_BOLD, anchor="w").pack(fill="x", padx=10, pady=(8,2))
            for team, score in [(home,home_score),(away,away_score)]:
                row = tk.Frame(card, bg=PANEL_DARK)
                row.pack(fill="x", padx=10, pady=2)
                tk.Label(row, text=self.team_initials(team), bg=PANEL_DARK,
                    fg=MUTED, font=FONT_MONO_SMALL, width=6).pack(side="left")
                ...
                tk.Label(row, text=str(score), bg=PANEL_DARK, fg=TEXT,
                    font=FONT_BOLD, width=4).pack(side="right")
    ...
    def chat_room_badge(self, match, room_name):
        ...
        if room_name == "Live Pulse" and match.get("status") == "LIVE": return "LIVE"
        if count >= 5: return "HOT"
        if room_name == "Post-match" and self.match_finished(match): return "FT"
        return ""
    ...
    def seed_chat_thread(self, match, room_name, minute):
        status_text = "pre-match room is open" if match.get("status") == "UP" else f"live room rolling at {minute:02d}'"
        seeds = {
            "Open Room": [
                {"author":"EdgeAgent","tag":"agent","time":self.chat_time_label(match),
                 "text":f"{match.get('home','')} vs {match.get('away','')} {status_text}. Market edge {match.get('edge',0):+.1f}."},
                {"author":"ValueHunter","tag":"community","time":self.chat_time_label(match),
                 "text":f"Watching whether {match.get('away','')} keeps pressure in the last 20."},
                {"author":"MatchPulse","tag":"community","time":self.chat_time_label(match),
                 "text":"Thread stays attached before kickoff, live, and after full-time."},
            ],
            "Value Talk": [
                {"author":"EdgeAgent","tag":"agent","time":self.chat_time_label(match),
                 "text":f"Value room open. Edge {match.get('edge',0):+.1f} vs available book prices."},
                {"author":"PriceWatcher","tag":"community","time":self.chat_time_label(match),
                 "text":"Only care whether the line is behind the state of the match."},
            ],
            "Live Pulse": [
                {"author":"EdgeAgent","tag":"agent","time":self.chat_time_label(match),
                 "text":f"Live pulse at {minute:02d}'. Use for momentum and pressure swings."},
                {"author":"PulseCheck","tag":"community","time":self.chat_time_label(match),
                 "text":"Room follows the replay minute so everyone argues the same state."},
            ],
            "Post-match": [
                {"author":"EdgeAgent","tag":"agent","time":self.chat_time_label(match),
                 "text":"Post-match room ready. Reviewing what market, replay, and result said."},
            ],
        }
    ...
    def render_chat_message(self, parent, item):
        ...
        tk.Label(top, text=item["author"], bg=PANEL_DARK, fg=color,
            font=FONT_BOLD, anchor="w").pack(side="left")
        tk.Label(top, text=item["time"], bg=PANEL_DARK, fg=MUTED,
            font=FONT_SMALL, anchor="e").pack(side="right")
        tk.Label(bubble, text=item["text"], bg=PANEL_DARK, fg=TEXT,
            font=FONT_SMALL, anchor="w", justify="left", wraplength=720).pack(fill="x", pady=(2,0))
        tk.Frame(bubble, bg="#243244", height=1).pack(fill="x", pady=(8,0))

    def post_chat_message(self, match):
        text = self.chat_message.get().strip()
        if not text:
            self.tracker_status.config(text="Type a message first.", fg=MUTED)
            return
        ...
        self.chat_message.set("")
        self.tracker_status.config(
            text=f"Posted into {match.get('home','')} vs {match.get('away','')} chat.", fg=GREEN)
        self.render_chat_preview()
        if self.tab_name.get() == "Chat":
            self.render_tab()
    ...
    def add_agent_note(self, match):
        ...
        self.tracker_status.config(text="Agent note added.", fg=CYAN)
        self.render_chat_preview()
        if self.tab_name.get() == "Chat":
            self.render_tab()
    ...
    def agent_chat_reply(self, match, prompt_text):
        ...
        if "shot" in lower or "xg" in lower:
            text = f"EdgeAgent: at {minute:02d}' the shot/xG angle still leans toward the attack view."
        elif "line" in lower or "odds" in lower or "price" in lower:
            text = f"EdgeAgent: the book side is worth checking against the current room take. Right panel has the discrepancy view."
        elif "lineup" in lower or "sub" in lower:
            text = f"EdgeAgent: lineup shape at {minute:02d}' is live in the Line-ups tab now."
        else:
            text = f"EdgeAgent: room note for {match.get('home','')} vs {match.get('away','')} at {minute:02d}' — keep the debate tied to replay minute, market move, and real edge."
        return {"author":"EdgeAgent","tag":"agent","time":self.chat_time_label(match),"text":text}

    def chat_time_label(self, match):
        minute = self.current_replay_minute(match)
        if match.get("status") == "UP" and minute == 0:
            return "Pre | now"
        return f"{minute:02d}' | now"

    def render_chat_preview(self):
        if not self.chat_preview_body:
            return
        ...
        tk.Label(header,
            ...
            bg=PANEL_DARK, fg=TEXT, font=FONT_BOLD, anchor="w").pack(fill="x")
        tk.Label(header, text=room, bg=PANEL_DARK, fg=CYAN,
            font=FONT_SMALL, anchor="w").pack(fill="x")
        for item in latest:
            row = tk.Frame(self.chat_preview_body, bg=PANEL_DARK)
            row.pack(fill="x", padx=8, pady=3)
            color = ORANGE if item["tag"]=="agent" else GREEN if item["tag"]=="you" else CYAN
            tk.Label(row, text=item["author"], bg=PANEL_DARK, fg=color,
        ...
        tk.Label(self.chat_preview_body,
            text="Open the Chat tab for the full room.",
            bg=PANEL_DARK, fg=MUTED, font=FONT_SMALL,
    ...
    def render_prediction_challenge(self, parent, match):
        ...
        tk.Label(top, text="Beat The Platform", bg=PANEL_DARK, fg=TEXT,
            font=FONT_BOLD, anchor="w").pack(side="left")
        tk.Label(top, text=f"Leader: {leader['name']}  |  {leader['accuracy']}%",
            bg=PANEL_DARK, fg=ORANGE, font=FONT_SMALL, anchor="e").pack(side="right")
        ...
        for label, value in [
            ...
            ("Guests",   str(len([r for r in entries if r["tag"]!="platform"]))),
        ...
        tk.Entry(form, textvariable=self.guest_handle, bg="#0f172a", fg=TEXT,
            insertbackground=TEXT, relief="flat", font=FONT_SMALL,
            width=14).pack(side="left", padx=(6,10), ipady=5)
        ...
        for market in ("1X2","O/U 2.5","BTTS"):
            ...
            tk.Button(market_frame, text=market,
                bg=TEXT if active else "#243244",
                fg=BG if active else MUTED,
                activebackground=TEXT, activeforeground=BG,
                relief="flat", font=FONT_SMALL, padx=10, pady=5,
                command=lambda v=market, c=match: self.set_guest_market(v, c)).pack(side="left", padx=3)
        ...
        for option in self.challenge_pick_options(match):
            ...
            tk.Button(pick_frame, text=option,
                bg=ORANGE if active else "#243244",
                fg=TEXT if active else MUTED,
                activebackground=ORANGE, activeforeground=TEXT,
                relief="flat", font=FONT_SMALL, padx=12, pady=6,
                command=lambda v=option: self.guest_pick.set(v)).pack(side="left", padx=(0,6))
        self.button(pick_frame,"Submit Pick",CYAN_DARK,
            lambda c=match: self.submit_guest_prediction(c),width=12,pady=7).pack(side="right")
        ...
        for idx, row in enumerate(entries[:6], start=1):
            ...
            for value, width, color in [
                (str(idx),4,MUTED),(row["name"],14,name_color),(row["market"],12,CYAN),
                (row["pick"],14,TEXT),(f"{row['confidence']}%",8,ORANGE),(f"{row['accuracy']}%",8,GREEN),
            ]:
                tk.Label(line, text=value, bg=line.cget("bg"), fg=color,
                    font=FONT_MONO_SMALL, width=width, anchor="w").pack(side="left", pady=4)
    ...
    def render_profile_board(self, parent):
        ...
        for idx, profile in enumerate(featured):
            ...
            tk.Label(box, text=profile["name"], bg="#243244",
                fg=ORANGE if profile["tag"]=="platform" else GREEN if profile["tag"]=="you" else TEXT,
                font=FONT_BOLD).pack()
            tk.Label(box, text=f"{profile['badge']}  |  streak {profile['streak']}",
                bg="#243244", fg=CYAN, font=FONT_SMALL).pack(pady=(2,2))
            tk.Label(box, text=f"hit {profile['hit_rate']}%  |  open {profile['open']}",
                bg="#243244", fg=TEXT, font=FONT_SMALL).pack(pady=(0,6))
        ...
        for row in self.profile_rows()[:6]:
            ...
            for value, width, color in [
                ...
                (f"{row['hit_rate']}%",8,GREEN),(str(row["open"]),8,MUTED),
    ...
    def render_platform_community_board(self, parent):
        ...
        top = tk.Frame(card, bg=PANEL_DARK)
        top.pack(fill="x", padx=10, pady=(8,6))
        tk.Label(top, text="Long-run settled score", bg=PANEL_DARK, fg=TEXT,
            font=FONT_BOLD, anchor="w").pack(side="left")
        tk.Label(top, text=f"{summary['winner']} on top", bg=PANEL_DARK, fg=ORANGE,
            font=FONT_SMALL, anchor="e").pack(side="right")
        row = tk.Frame(card, bg=PANEL_DARK)
    ...
    def make_history_record(self, name, tag, market, pick, confidence, home_score, away_score, match_id):
        ...
        return {"name":name,"tag":tag,"market":market,"pick":pick,
                "confidence":confidence,"home_score":home_score,
                "away_score":away_score,"match_id":match_id,
    ...
    def challenge_entries(self, match):
        ...
        return sorted(rows, key=lambda x:(x["accuracy"],x["confidence"]), reverse=True)

    def seed_challenge_entries(self, match):
        return [
            {"name":"SharpTom","tag":"guest","market":"1X2","pick":match.get("away","Away"),"confidence":58,"accuracy":67},
    ...
    def platform_challenge_entry(self, match):
        ...
        return {
            "name":"Edge Platform","tag":"platform","market":"1X2",
    ...
    def submit_guest_prediction(self, match):
        ...
        rows.append({"name":handle,"tag":"you","market":self.guest_market.get(),
                     "pick":pick,"confidence":confidence,"accuracy":accuracy})
        self.challenge_history.append({"name":handle,"tag":"you",
            "market":self.guest_market.get(),"pick":pick,"confidence":confidence,
            "home_score":match.get("home_score",0),"away_score":match.get("away_score",0),
            "match_id":match["id"],
            "status":"Live" if match.get("status")=="LIVE" else "Pending","result":"Open"})
        self.tracker_status.config(
            text=f"{handle} joined the challenge on {match.get('home','')} vs {match.get('away','')}.",
            fg=GREEN)
        self.render_chat_preview()
        if self.tab_name.get() == "Chat":
            self.render_tab()
    ...
    def challenge_confidence(self, match, pick):
        consensus = self.consensus_prediction(match)
        if pick == match.get("home"):  return consensus["home"]
        if pick == match.get("away"):  return consensus["away"]
        if pick == "Draw":             return consensus["draw"]
        if pick == "Over 2.5":         return min(78, int(round(match.get("over_price",50))))
        if pick == "Under 2.5":        return min(78, int(round(match.get("under_price",50))))
        if pick == "Yes":              return min(76, int(round((match.get("home_avg",1.5)+match.get("away_avg",1.5))*18)))
        return 100 - min(76, int(round((match.get("home_avg",1.5)+match.get("away_avg",1.5))*18)))
    ...
    def settle_pick(self, market, pick, home_score, away_score):
        if market == "1X2":
            ...
            home_teams = {m.get("home","") for m in MATCHES}
            if pick == "Draw": mapped = "Draw"
            elif pick in home_teams: mapped = "Home"
            else: mapped = "Away"
            return "W" if mapped==outcome else "L"
        if market == "O/U 2.5":
            return "W" if (pick=="Over 2.5" and home_score+away_score>=3) or (pick=="Under 2.5" and home_score+away_score<3) else "L"
        if market == "BTTS":
            return "W" if (pick=="Yes" and home_score>0 and away_score>0) or (pick=="No" and not(home_score>0 and away_score>0)) else "L"
        return "P"

    def profile_rows(self):
        buckets = {}
        for item in self.challenge_history:
            row = buckets.setdefault(item["name"],{
                "name":item["name"],"tag":item["tag"],
                "wins":0,"losses":0,"pushes":0,"open":0,
                "best_market":item["market"],"history":[]})
            row["history"].append(item["result"])
            if item["status"] == "Settled":
                if item["result"]=="W":   row["wins"]   += 1
                elif item["result"]=="L": row["losses"] += 1
                else:                     row["pushes"] += 1
            else: row["open"] += 1
        rows = []
        for row in buckets.values():
            settled = row["wins"]+row["losses"]+row["pushes"]
            row["hit_rate"] = 0 if settled==0 else int(round(row["wins"]/max(1,settled)*100))
            row["streak"]   = self.profile_streak(row["history"])
            row["badge"]    = self.profile_badge(row)
            rows.append(row)
        return sorted(rows, key=lambda x:(x["hit_rate"],x["wins"]), reverse=True)

    def profile_lookup(self, name):
        for row in self.profile_rows():
            if row["name"] == name: return row
        return {"name":name,"tag":"guest","wins":0,"losses":0,"pushes":0,
                "open":0,"best_market":"1X2","hit_rate":0,"streak":"0","badge":"New"}

    def top_guest_profile(self):
        guests = [r for r in self.profile_rows() if r["tag"]!="platform"]
    ...
    def profile_streak(self, history):
        ...
        for result in reversed(history):
            ...
            if streak_type is None: streak_type, streak_count = result, 1
            elif result == streak_type: streak_count += 1
            else: break
        return "0" if streak_type is None else f"{streak_type}{streak_count}"

    def profile_badge(self, row):
        if row["tag"]=="platform": return "Crown"
        if row["streak"].startswith("W") and int(row["streak"][1:] or "0")>=2: return "Hot"
        if row["open"]>=2: return "Active"
        return "New"

    def platform_vs_community_summary(self):
        p = {"wins":0,"losses":0,"pushes":0,"open":0}
        c = {"wins":0,"losses":0,"pushes":0,"open":0}
        for item in self.challenge_history:
            bucket = p if item["tag"]=="platform" else c
            if item["status"]=="Settled":
                if item["result"]=="W":   bucket["wins"]   += 1
                elif item["result"]=="L": bucket["losses"] += 1
                else:                     bucket["pushes"] += 1
            else: bucket["open"] += 1
        ps = p["wins"]+p["losses"]+p["pushes"]
        cs = c["wins"]+c["losses"]+c["pushes"]
        ph = 0 if ps==0 else int(round(p["wins"]/max(1,ps)*100))
        ch = 0 if cs==0 else int(round(c["wins"]/max(1,cs)*100))
        return {
            "platform_hit":ph,"community_hit":ch,
            "platform_wins":p["wins"],"platform_losses":p["losses"],"platform_pushes":p["pushes"],
            "community_wins":c["wins"],"community_losses":c["losses"],"community_pushes":c["pushes"],
            "settled":ps+cs,"open":p["open"]+c["open"],
            "winner":"Platform" if ph>=ch else "Community",
        }
    ...
    def settle_match_challenges(self, match):
        for item in self.challenge_history:
            if item["match_id"]!=match["id"] or item["status"]=="Settled": continue
            item["home_score"] = match.get("home_score",0)
            item["away_score"] = match.get("away_score",0)
            item["result"]     = self.settle_pick(item["market"],item["pick"],item["home_score"],item["away_score"])
            item["status"]     = "Settled"
    ...
    def render_decision_engine(self):
        ...
        tk.Label(top, text=snapshot["decision"], bg=PANEL_DARK,
            fg=snapshot["decision_color"], font=("Segoe UI",16,"bold"), anchor="w").pack(fill="x", padx=10, pady=(8,2))
        tk.Label(top, text=snapshot["market"], bg=PANEL_DARK, fg=TEXT,
            font=FONT_BOLD, anchor="w").pack(fill="x", padx=10)
        tk.Label(top,
            text=f"Confidence {snapshot['confidence']}%  |  Edge {snapshot['edge']:+.1f}  |  Data quality {snapshot['data_quality']}%",
            bg=PANEL_DARK, fg=MUTED, font=FONT_SMALL, anchor="w").pack(fill="x", padx=10, pady=(0,8))
        ...
        for reason in snapshot["reasons_for"]:
            tk.Label(likes, text=f"+ {reason}", bg=PANEL_DARK, fg=GREEN,
                font=FONT_SMALL, anchor="w", justify="left").pack(fill="x", padx=10, pady=2)
        ...
        for reason in snapshot["reasons_against"]:
            tk.Label(cautions, text=f"- {reason}", bg=PANEL_DARK, fg=RED,
                font=FONT_SMALL, anchor="w", justify="left").pack(fill="x", padx=10, pady=2)
        ...
        for rule in snapshot["risk_controls"]:
            tk.Label(risk, text=f"* {rule}", bg=PANEL_DARK, fg=MUTED,
                font=FONT_SMALL, anchor="w", justify="left").pack(fill="x", padx=10, pady=2)
    ...
    def render_data_quality(self):
        ...
        for label, value in snapshot["data_buckets"]:
            ...
            tk.Label(line, text=label, bg=PANEL_DARK, fg=CYAN,
                font=FONT_SMALL, width=14, anchor="w").pack(side="left")
            tk.Label(line, text=value, bg=PANEL_DARK, fg=TEXT,
                font=FONT_SMALL, anchor="w").pack(side="left")
    ...
    def render_source_monitor(self):
        ...
        for source, kind, state, weight in snapshot["sources"]:
            ...
            for value, width, color in [
                (source,14,TEXT),(kind,10,MUTED),(state,12,state_color),(weight,8,CYAN)]:
                tk.Label(row, text=value, bg=ROW, fg=color,
                    font=FONT_MONO_SMALL, width=width, anchor="w").pack(side="left", pady=4)
        footer = self.info_card(self.source_body)
        footer.pack(fill="x", padx=6, pady=(4,4))
        tk.Label(footer,
            text=f"Consensus spread: {snapshot['consensus_spread']} pts  |  Books: {snapshot['books_tracked']}  |  Sources: {snapshot['prediction_sources']}",
            bg=PANEL_DARK, fg=MUTED, font=FONT_SMALL, anchor="w").pack(fill="x", padx=10, pady=(6,4))
        tk.Label(footer,
            text=f"Market move: {snapshot['market_move']}  |  Referee: {snapshot['referee_note']}",
            bg=PANEL_DARK, fg=TEXT, font=FONT_SMALL, anchor="w").pack(fill="x", padx=10, pady=(0,6))
    ...
    def render_watchlist(self):
        ...
        if not items:
            tk.Label(self.watchlist_frame,
                ...
                bg=PANEL_DARK, fg=MUTED, font=FONT_MONO_SMALL,
                anchor="center", pady=8).pack(fill="x", padx=4)
            return
        for match in items:
    ...
    def render_sidebar_watchlist(self):
        ...
        message = "No matches in watchlist." if not items else "\n".join(
            f"{m.get('home','')} vs {m.get('away','')}" for m in items[:4])
        tk.Label(self.sidebar_watch_body, text=message, bg=PANEL_DARK, fg=MUTED,
    ...
    def render_accuracy(self):
        ...
        try:
            ...
            settled, rec_hit, draw_hit, under_hit = 12, 75.0, 60.0, 80.0
        tk.Label(self.accuracy_body, text="ACCURACY SUMMARY", bg=PANEL,
            fg=ORANGE, font=FONT_MONO_SMALL, anchor="w").pack(fill="x", padx=8, pady=(8,3))
        for label, value in [
            ("Settled analyses", settled), ("Recommended hit %", rec_hit),
            ("Draw outcome %", draw_hit),  ("Under 2.5 hit %", under_hit),
        ]:
            row = tk.Frame(self.accuracy_body, bg=PANEL)
            row.pack(fill="x", padx=8, pady=1)
            tk.Label(row, text=f"{label}:", bg=PANEL, fg=MUTED,
                font=FONT_MONO_SMALL, width=24, anchor="w").pack(side="left")
            tk.Label(row, text=str(value), bg=PANEL, fg=GREEN,
                font=FONT_MONO_SMALL, anchor="e").pack(side="right")
        community = self.platform_vs_community_summary()
        tk.Label(self.accuracy_body, text="PLATFORM VS COMMUNITY", bg=PANEL,
            fg=CYAN, font=FONT_MONO_SMALL, anchor="w").pack(fill="x", padx=8, pady=(10,3))
        for label, value, color in [
            ("Platform hit %", community["platform_hit"], ORANGE),
            ("Community hit %",community["community_hit"],CYAN),
            ("Settled picks",  community["settled"],      GREEN),
            ("Open picks",     community["open"],         MUTED),
        ]:
            row = tk.Frame(self.accuracy_body, bg=PANEL)
            row.pack(fill="x", padx=8, pady=1)
            tk.Label(row, text=f"{label}:", bg=PANEL, fg=MUTED,
                font=FONT_MONO_SMALL, width=24, anchor="w").pack(side="left")
            tk.Label(row, text=str(value), bg=PANEL, fg=color,
                font=FONT_MONO_SMALL, anchor="e").pack(side="right")
    ...
    def add_current_to_watchlist(self):
        ...
        try:
            ...
            pass
        self.tracker_status.config(
            text=f"{match.get('home','')} vs {match.get('away','')} added to watchlist.", fg=GREEN)
        self.render_matches()
        self.render_watchlist()
        self.render_sidebar_watchlist()
    ...
    def remove_current_from_watchlist(self):
        ...
        self.tracker_status.config(
            text=f"{match.get('home','')} vs {match.get('away','')} removed from watchlist.", fg=MUTED)
        self.render_matches()
        self.render_watchlist()
        self.render_sidebar_watchlist()
    ...
    def state_from_match(self, match):
        return MatchState(
            ...
            pressure_bias=1 if match.get("edge",0)>0 else 0)

    def market_from_match(self, match):
        return MarketInput(total_line=2.5,
            draw_cents=match.get("draw_price",33.0),
            under_cents=match.get("under_price",50.0),
            over_cents=match.get("over_price",50.0))
    ...
    def run_analysis(self):
        ...
        best_label, best_edge = max(edges, key=lambda x: x[1])
        ...
        try:
            log_analysis({
                ...
                "home_reds":state.home_red_cards,"away_reds":state.away_red_cards,
                "pressure":state.pressure_bias,"draw_price":market.draw_cents,
                "under_price":market.under_cents,"over_price":market.over_cents,
                "recommended":best_label,"confidence":round(confidence,1),
                "best_edge":round(best_edge,1),
            })
        except Exception:
            pass
        HISTORY_SAMPLE.insert(0,(str(len(HISTORY_SAMPLE)+1),"LIVE",
            f"{match.get('home','')} vs {match.get('away','')}",best_label,best_edge,"NO"))
    ...
    def tracker_tick(self):
        ...
        if self.current_match.get("status")=="LIVE" and self.current_match.get("minute",0)<90:
    ...
    def test_speed(self):
        self.status_label.config(
            text=f"Last Load: instant  |  Matches: {len(self.filtered_matches())}")

    def on_mousewheel(self, event):
        widget = self.root.focus_get()
        if widget and str(widget).startswith(str(self.matches_canvas)):
    ...
    def match_stats(self, match):
        home_edge = max(match.get("edge",0), 0)
        return [
            ("Expected goals (xG)", round(0.8+home_edge/10,2), round(0.7+abs(min(match.get("edge",0),0))/10,2)),
            ("Shots on target", 5 if match.get("home_score",0) else 2, 3 if match.get("away_score",0) else 2),
            ("Shots off target",6,4),("Blocked shots",4,2),
            ("Possession (%)", 54 if match.get("edge",0)>=0 else 47, 46 if match.get("edge",0)>=0 else 53),
    ...
    def stats_max_minute(self, match):
        return max(match.get("minute",1), 1) if match.get("status")=="LIVE" else 90

    def stats_reference_minute(self, match):
        if match.get("status")=="LIVE": return max(match.get("minute",1), 1)
        if match.get("status")=="UP":   return 0
        return 90

    def current_replay_minute(self, match):
        max_minute = self.stats_max_minute(match)
        if self.replay_minute is None: return self.stats_reference_minute(match)
        return max(0, min(int(self.replay_minute), max_minute))

    def stat_map(self, match, minute=None, max_minute=None):
        if max_minute is None: max_minute = self.stats_max_minute(match)
        if minute is None:     minute     = self.current_replay_minute(match)
        return {label:(h,a) for label,h,a in self.match_stats_at_minute(match,minute,max_minute)}

    def match_stats_at_minute(self, match, minute, max_minute=90):
        ratio = 0 if max_minute<=0 else max(0.0, min(minute/max_minute, 1.0))
        live_bias = ((match.get("id",1)%5)-2)/14
        rows = []
        for label, final_home, final_away in self.match_stats(match):
            if label == "Possession (%)":
                ...
                rows.append((label, int(round(home_share)), int(round(100-home_share))))
                continue
            hp = max(0.0, ratio+live_bias*0.18)
            ap = max(0.0, ratio-live_bias*0.18)
            if label == "Expected goals (xG)":
                rows.append((label, round(final_home*self.timeline_curve(hp),2), round(final_away*self.timeline_curve(ap),2)))
            else:
                rows.append((label, int(round(final_home*self.timeline_curve(hp))), int(round(final_away*self.timeline_curve(ap)))))
        if match.get("status")=="UP" and minute==0:
            return [(label, 50 if label=="Possession (%)" else 0.0 if label=="Expected goals (xG)" else 0,
                           50 if label=="Possession (%)" else 0.0 if label=="Expected goals (xG)" else 0)
                    for label,_,_ in rows]
        return rows

    def stats_summary_percentages(self, match, minute, max_minute=90):
        stats = {label:(h,a) for label,h,a in self.match_stats_at_minute(match,minute,max_minute)}
        xg_h, xg_a   = stats.get("Expected goals (xG)",(0.0,0.0))
        sot_h,sot_a   = stats.get("Shots on target",(0,0))
        pos_h,pos_a   = stats.get("Possession (%)",(50,50))
        cor_h,cor_a   = stats.get("Corner kicks",(0,0))
        def split(l,r):
            t=l+r
            if t<=0: return 50,50
            lp=int(round(l/t*100)); return lp,max(0,100-lp)
        return [
            ("xG Share",    *split(xg_h,  xg_a)),
            ("Shot Quality",*split(sot_h, sot_a)),
            ("Possession",  int(pos_h), int(pos_a)),
            ("Pressure",    *split(cor_h, cor_a)),
        ]
    ...
    def attack_stats(self, match, minute, max_minute):
        s = self.stat_map(match, minute, max_minute)
        xg_h,xg_a   = s.get("Expected goals (xG)",(0.0,0.0))
        sot_h,sot_a  = s.get("Shots on target",(0,0))
        off_h,off_a  = s.get("Shots off target",(0,0))
        blk_h,blk_a  = s.get("Blocked shots",(0,0))
        crs_h,crs_a  = s.get("Crosses",(0,0))
        cor_h,cor_a  = s.get("Corner kicks",(0,0))
        return [
            ("Expected goals (xG)", xg_h, xg_a),
            ("Shots on target", sot_h, sot_a),
            ("Shots off target", off_h, off_a),
            ("Blocked shots", blk_h, blk_a),
            ("Big chances", max(0,int(round(sot_h*0.6+xg_h*1.5))), max(0,int(round(sot_a*0.6+xg_a*1.5)))),
            ("Touches in box", sot_h+off_h+int(round(crs_h*0.4)), sot_a+off_a+int(round(crs_a*0.4))),
            ("Crosses", crs_h, crs_a),
            ("Shot accuracy (%)", int(round(sot_h/max(sot_h+off_h+blk_h,1)*100)), int(round(sot_a/max(sot_a+off_a+blk_a,1)*100))),
            ("Set-piece threat", cor_h, cor_a),
        ]

    def attack_summary_percentages(self, match, minute, max_minute):
        rows = {label:(h,a) for label,h,a in self.attack_stats(match,minute,max_minute)}
        def split(l,r):
            t=l+r
            if t<=0: return 50,50
            lp=int(round(l/t*100)); return lp,max(0,100-lp)
        return [
            ("xG Threat",  *split(*rows["Expected goals (xG)"])),
            ("On Target",  *split(*rows["Shots on target"])),
            ("Box Threat", *split(*rows["Touches in box"])),
            ("Accuracy",   rows["Shot accuracy (%)"][0], rows["Shot accuracy (%)"][1]),
        ]

    def attack_players(self, match, team, minute, max_minute):
        ratio = 0 if max_minute<=0 else max(0.0, min(minute/max_minute,1.0))
        if team == match.get("home"):
            names=["Erling Haaland","Phil Foden","Kevin De Bruyne"]
            xg_base=[0.38,0.18,0.14]; action_base=[4,3,5]
        else:
            names=["Mohamed Salah","Darwin Nunez","Luis Diaz"]
            xg_base=[0.34,0.22,0.16]; action_base=[4,3,4]
        rows = []
        for idx, name in enumerate(names):
            xg      = round(xg_base[idx]*(0.45+ratio*0.75),2)
            shots   = max(1,int(round(action_base[idx]*(0.4+ratio*0.8))))
            kp      = max(0,int(round((action_base[idx]-1)*(0.3+ratio*0.7))))
            touches = max(1,int(round(shots+kp+ratio*3+idx)))
            rows.append({"name":name,"team":team,
                "summary":f"xG {xg}  |  shots {shots}  |  key passes {kp}",
                "headline":f"{name} is a main attacking driver for {team}.",
                "metrics":[("xG",f"{xg:.2f}"),("Shots",str(shots)),("Key Passes",str(kp)),("Box Touches",str(touches))],
                "notes":[f"Shot volume building toward {minute:02d}'.",
                    "Value from central combinations and second-ball attacks.",
                    "Compare player-level threat against team totals above."]})
        return rows

    def control_stats(self, match, minute, max_minute):
        s = self.stat_map(match, minute, max_minute)
        pos_h,pos_a  = s.get("Possession (%)",(50,50))
        thr_h,thr_a  = s.get("Throw ins",(0,0))
        cor_h,cor_a  = s.get("Corner kicks",(0,0))
        crs_h,crs_a  = s.get("Crosses",(0,0))
        ratio = 0 if max_minute<=0 else max(0.0,min(minute/max_minute,1.0))
        pa_h = int(round(76+pos_h*0.18+ratio*4))
        pa_a = int(round(76+pos_a*0.18+ratio*4))
        tilt_h = int(round(min(78,max(22,pos_h+cor_h*2+match.get("edge",0)*1.5))))
        prog_h = max(1,int(round(crs_h*0.8+thr_h*0.35+ratio*8)))
        prog_a = max(1,int(round(crs_a*0.8+thr_a*0.35+ratio*8)))
        tempo_h = max(1,int(round((thr_h+cor_h+crs_h)*0.9)))
        tempo_a = max(1,int(round((thr_a+cor_a+crs_a)*0.9)))
        return [
            ("Possession (%)",pos_h,pos_a),("Pass accuracy (%)",pa_h,pa_a),
            ("Field tilt (%)",tilt_h,100-tilt_h),
            ("Progressive entries",prog_h,prog_a),
            ("Corners won",cor_h,cor_a),("Cross volume",crs_h,crs_a),
            ("Tempo actions",tempo_h,tempo_a),("Restarts / throw-ins",thr_h,thr_a),
        ]

    def control_summary_percentages(self, match, minute, max_minute):
        rows = {label:(h,a) for label,h,a in self.control_stats(match,minute,max_minute)}
        def split(l,r):
            t=l+r
            if t<=0: return 50,50
            lp=int(round(l/t*100)); return lp,max(0,100-lp)
        return [
            ...
            ("Pass Clean",  rows["Pass accuracy (%)"][0], rows["Pass accuracy (%)"][1]),
            ("Field Tilt",  rows["Field tilt (%)"][0], rows["Field tilt (%)"][1]),
            ("Progression", *split(*rows["Progressive entries"])),
        ]

    def defense_stats(self, match, minute, max_minute):
        s = self.stat_map(match, minute, max_minute)
        fouls_h,fouls_a = s.get("Fouls",(0,0))
        yel_h,yel_a     = s.get("Yellow cards",(0,0))
        saves_h,saves_a = s.get("Goalkeeper saves",(0,0))
        off_h,off_a     = s.get("Offsides",(0,0))
        blk_h,blk_a     = s.get("Blocked shots",(0,0))
        ratio = 0 if max_minute<=0 else max(0.0,min(minute/max_minute,1.0))
        duel_h = max(1,int(round(9+ratio*11+max(match.get("edge",0),0))))
        duel_a = max(1,int(round(9+ratio*11+abs(min(match.get("edge",0),0)))))
        inter_h= max(1,int(round(blk_h*1.6+off_h+ratio*5)))
        inter_a= max(1,int(round(blk_a*1.6+off_a+ratio*5)))
        clear_h= max(1,int(round(saves_h*2.2+fouls_h*0.5+ratio*4)))
        clear_a= max(1,int(round(saves_a*2.2+fouls_a*0.5+ratio*4)))
        return [
            ("Goalkeeper saves",saves_h,saves_a),("Blocked shots",blk_h,blk_a),
            ("Interceptions",inter_h,inter_a),("Clearances",clear_h,clear_a),
            ("Duels won",duel_h,duel_a),("Offsides forced",off_h,off_a),
            ("Fouls committed",fouls_h,fouls_a),("Yellow cards",yel_h,yel_a),
        ]

    def defense_summary_percentages(self, match, minute, max_minute):
        rows = {label:(h,a) for label,h,a in self.defense_stats(match,minute,max_minute)}
        def split(l,r):
            t=l+r
            if t<=0: return 50,50
            lp=int(round(l/t*100)); return lp,max(0,100-lp)
        yel_h,yel_a = rows["Yellow cards"]
        disc_l,disc_r = split(max(1,5-yel_h),max(1,5-yel_a))
        return [
            ("Duel Share",    *split(*rows["Duels won"])),
            ("Save Load",     *split(*rows["Goalkeeper saves"])),
            ("Interceptions", *split(*rows["Interceptions"])),
            ("Discipline",    disc_l, disc_r),
        ]
    ...
    def defense_players(self, match, team, minute, max_minute):
        ...
        if team == match.get("home"):
            ...
            tackle_base=[3,4,1]; duel_base=[6,7,1]
        else:
            names=["Virgil van Dijk","Alexis Mac Allister","Alisson"]
            tackle_base=[3,4,1]; duel_base=[7,6,1]
        rows = []
        for idx, name in enumerate(names):
            ...
            rows.append({"name":name,"team":team,
                ...
                "headline":f"{name} carries a big share of defensive work for {team}.",
                "metrics":[("Tackles",str(tackles)),("Duels",str(duels)),
                    ("Recoveries",str(recoveries)),("Def Actions",str(tackles+duels+recoveries))],
                "notes":["Good for spotting proactive vs absorbing defense.",
                    "Higher recovery volume often lines up with field tilt stress.",
                    f"Snapshot reflects replay state at {minute:02d}'."]})
        return rows

    def percentage_split(self, left, right):
        total = left+right
        if total<=0: return 50,50
        lp = int(round(left/total*100))
        return lp, max(0,100-lp)

    def odds_rows(self, match):
        base_home,base_draw,base_away = match.get("odds",(2.0,3.5,4.0))
        books = [
        ...
        return [(book,
            max(1.01,base_home+h), max(1.01,base_draw+d), max(1.01,base_away+a),
            round(match.get("edge",0)+((idx%4)-1.5)*0.7,1))
            for idx,(book,h,d,a) in enumerate(books)]

    def odds_detail_rows(self, match, book_name):
        book_row = next((r for r in self.odds_rows(match) if r[0]==book_name), self.odds_rows(match)[0])
        ...
        return [
            ...
            ("Asian Handicap",f"{match.get('home','')} -0.25","",f"{match.get('away','')} +0.25","model value"),
            ("Corners O/U 9.5","Over 1.87","","Under 1.98","edge small"),
            ("Cards O/U 4.5","Over 1.73","","Under 2.08","ref linked"),
            ("Next Goal",f"{match.get('home','')} 2.40","",f"{match.get('away','')} 2.75","live only"),
        ]

    def prediction_rows(self, match):
        home,draw,away = match.get("pred",(33,33,34))
        sources = [
            ("Opta",3,-1,-2),("Forebet",-2,1,1),("PredictZ",1,2,-3),
            ("SportsMole",-1,-2,3),("WinDrawWin",2,0,-2),
            ("Betimate",-3,3,0),("SoccerVista",0,-1,1),
            ("Our Model",round(match.get("edge",0)),0,-round(match.get("edge",0))),
        ]
        rows = []
        for source,h_adj,d_adj,a_adj in sources:
            ...
            total = h+d+a
            h=round(h*100/total); d=round(d*100/total); a=max(1,100-h-d)
            pick = match.get("home") if h>=d and h>=a else match.get("away") if a>=d else "Draw"
            rows.append((source,h,d,a,pick))
        return rows

    def prediction_detail_snapshot(self, match, source_name):
        row = next((r for r in self.prediction_rows(match) if r[0]==source_name), self.prediction_rows(match)[0])
        _,home,draw,away,pick = row
        return {
            "headline":f"{source_name} leans {pick} for {match.get('home','')} vs {match.get('away','')}",
            ...
            "updated":"live" if match.get("status")=="LIVE" else "pre-match",
            "markets":[
                ("1X2",f"{home}% / {draw}% / {away}%"),
                ("Over 2.5",f"{min(78,away+12)}%"),
                ("Under 2.5",f"{max(22,100-away-12)}%"),
                ("BTTS",f"{52+(match.get('home_score',0)+match.get('away_score',0))*6}%"),
                ("Most likely score","1-1" if draw>=max(home,away)-4 else "1-2" if pick==match.get("away") else "2-1"),
                ("Fair line",f"{pick} {round(100/max(home,away),2)}"),
            ],
            "reasons":[
                f"{source_name} weights recent form and matchup profile heavily.",
                f"{match.get('away','')} pressure improves away scenario." if pick==match.get("away") else f"{match.get('home','')} control profile improves home scenario." if pick==match.get("home") else "Balanced game state keeps draw alive.",
                "Weather, referee, and market movement included as secondary adjustments.",
            ],
            "flags":[
                "Consensus can lag behind very recent lineup changes.",
                "Source-specific scoreline markets are noisier than moneyline probabilities.",
    ...
    def consensus_prediction(self, match):
        ...
        home_avg = round(sum(r[1] for r in rows)/len(rows))
        draw_avg = round(sum(r[2] for r in rows)/len(rows))
        away_avg = round(sum(r[3] for r in rows)/len(rows))
        pick = match.get("home") if home_avg>=draw_avg and home_avg>=away_avg else match.get("away") if away_avg>=draw_avg else "Draw"
        return {"home":home_avg,"draw":draw_avg,"away":away_avg,
                "pick":pick,"confidence":max(home_avg,draw_avg,away_avg)}

    def analysis_snapshot(self, match):
        consensus = self.consensus_prediction(match)
        odds      = self.odds_rows(match)
        best_book = max(odds, key=lambda x: x[4])
        market_prob = round(100/best_book[1]) if consensus["pick"]==match.get("home") else round(100/best_book[3]) if consensus["pick"]==match.get("away") else round(100/best_book[2])
        ...
        decision = "PASS"; decision_color = MUTED
        if data_quality>=82 and edge>=5 and lineup_status=="Confirmed":
            decision="BET"; decision_color=GREEN
        elif data_quality>=70 and edge>=2:
            decision="LEAN"; decision_color=ORANGE
        ...
        reasons_for = [
            ...
            f"Form: {match.get('home','')} {''.join(match.get('home_form',['?']*5))} vs {match.get('away','')} {''.join(match.get('away_form',['?']*5))}.",
        ]
        if match.get("status")=="LIVE":
            reasons_for.append(f"Live state {match.get('minute',0)}' at {match.get('home_score',0)}-{match.get('away_score',0)} keeps the signal active.")
        reasons_against = [
            f"Market move is {market_move.lower()}, so late entries may lose value.",
            f"Weather and referee context can shift pace ({weather.lower()}, {match.get('referee','')}).",
        ...
        return {
            ...
            "confidence":true_prob,"edge":edge,
            "true_prob":true_prob,"market_prob":market_prob,
            ...
            "weather":weather,"news_status":self.news_status(match),
            ...
            "risk_controls":[
                ...
                "No stacking correlated bets without re-checking line movement.",
                "Downgrade to pass if lineup/news changes within final refresh window.",
            ],
            "data_buckets":[
                ("Match state",f"{match.get('status','')} {match.get('minute',0)}'  score {match.get('home_score',0)}-{match.get('away_score',0)}"),
                ("Team profile",f"Attack {match.get('home_avg',0):.1f}/{match.get('away_avg',0):.1f}  form {''.join(match.get('home_form',['?']*5))}/{''.join(match.get('away_form',['?']*5))}"),
                ...
                ("Context",f"{weather}  ref {match.get('referee','')}  venue {match.get('venue','')}"),
                ("News",f"{self.news_status(match)}  local {self.local_news_note(match)}"),
            ],
            "missing":missing,
            "sources":[
    ...
    def data_quality_score(self, match):
        score = 76
        if match.get("status")=="LIVE": score += 6
        if abs(match.get("edge",0))>=4:  score += 4
        if match.get("minute",0)==0:     score -= 3
        if match.get("home") in ("Man City","Real Madrid","Inter Milan"): score += 3
        return max(55, min(score, 94))

    def freshness_label(self, match):
        if match.get("status")=="LIVE": return "15s live"
        if match.get("minute",0)==0:    return "5m pre"
        return "30m old"

    def lineup_status(self, match):
        if match.get("status")=="LIVE": return "Confirmed"
        if match.get("minute",0)==0 and match.get("edge",0)>=4: return "Partial"
        return "Pending"

    def weather_label(self, match):
        return {"England":"Light rain 11C","Spain":"Clear 17C",
                "Italy":"Calm 15C","Germany":"Windy 9C"}.get(match.get("country",""), "Normal 14C")

    def injury_status(self, match):
        return "minor doubts" if abs(match.get("edge",0))<3 else "mostly clear"

    def news_status(self, match):
        return "2 local reports checked" if match.get("status")=="LIVE" else "Awaiting pre-match pressers"

    def news_state(self, match):
        return "Confirmed" if match.get("status")=="LIVE" else "Checking"

    def local_news_note(self, match):
        return "travel and rotation flagged" if match.get("away") in ("Liverpool","Barcelona","Napoli") else "quiet local cycle"

    def market_movement_label(self, match):
        edge = match.get("edge",0)
        return "Sharp move to away" if edge<-2 else "Mild move to home" if edge>4 else "Flat market"

    def missing_inputs(self, match):
        missing = []
        if match.get("status")!="LIVE":       missing.append("confirmed lineups")
        if abs(match.get("edge",0))<2:         missing.append("clear market discrepancy")
        if match.get("country")=="Germany":    missing.append("local reporter confirmation")
        return missing or ["None"]

    def consensus_spread(self, match):
        rows  = self.prediction_rows(match)
        picks = [r[4] for r in rows]
        leader = max(set(picks), key=picks.count)
        return picks.count(leader)

    def referee_note(self, match):
        ref = match.get("referee","")
        return "card-happy profile" if "Taylor" in ref or "Oliver" in ref else "balanced whistle"

    def match_events(self, match):
        if match.get("status")=="LIVE":
            return [
                ("09'",match.get("home",""),"SHOT","Early low shot forced a near-post save"),
                ("24'",match.get("home",""),"CARD","Tactical foul stopped a transition"),
                ("33'",match.get("away",""),"SAVE","Keeper denied a close-range finish"),
                ("41'",match.get("away",""),"GOAL",f"{match.get('away','')} took the lead after a quick break"),
                ("HT","Match","SCORE",f"{match.get('home_score',0)} - {match.get('away_score',0)} at the break"),
                ("58'",match.get("home",""),"SUB","Fresh winger introduced to raise tempo"),
                ("63'",match.get("away",""),"VAR","Penalty shout checked and waved away"),
                (f"{match.get('minute',0)}'",match.get("home",""),"PRESS","Home side pushing higher and winning second balls"),
            ]
        if match.get("minute",0)==0:
            return [("00'","Match","INFO","Pre-match view — replay fills once live or historical data loaded")]
        return [
            ("12'",match.get("home",""),"SHOT","Early chance saved low to the keeper's left"),
            ("27'",match.get("away",""),"GOAL","Back-post finish after a diagonal switch"),
            ("49'",match.get("home",""),"SUB","Midfield change to control the center"),
            ("68'",match.get("away",""),"CARD","Late challenge in transition"),
            ("74'",match.get("home",""),"PRESS","Sustained spell pinned the away side deep"),
            ("FT","Match","SCORE",f"{match.get('home_score',0)} - {match.get('away_score',0)} full-time"),
        ]
    ...
    def timeline_events(self, match, max_minute):
        ...
        for minute_text,team,event,detail in self.match_events(match):
            ...
            events.append({"minute":minute,"minute_text":minute_text,
                "team":team or "Match","event":event,"detail":detail})
        return events

    def event_minute_value(self, minute_text, max_minute):
        text = str(minute_text).strip().upper().replace("'","")
        if text=="HT": return min(45, max_minute)
        if text=="FT": return max_minute
    ...
    def table_rows(self, match):
        base = [
            ...
            ("Sassuolo",33,-3,45,13),("Udinese",33,-5,43,12),("Torino",33,-17,40,11),
        ]
        teams = [r[0] for r in base]
        if match.get("home") not in teams: base.insert(6,(match.get("home",""),33,8,51,13))
        if match.get("away") not in teams: base.insert(3,(match.get("away",""),33,20,64,18))
        return [(idx,*row) for idx,row in enumerate(base[:14],start=1)]

    def h2h_rows(self, match):
        return [
            ("2025",     match.get("away",""), match.get("home",""), 3, 0),
            ("2024/25",  match.get("away",""), match.get("home",""), 1, 0),
            ("2024",     match.get("home",""), match.get("away",""), 0, 1),
            ("2023/24",  match.get("home",""), match.get("away",""), 1, 3),
            ("2023",     match.get("away",""), match.get("home",""), 1, 0),
            ("2022/23",  match.get("away",""), match.get("home",""), 3, 1),
        ]

    def lineup_formation(self, match, side, minute):
        if side=="home": return "4-3-3" if minute<58 else "4-2-3-1"
    ...
    def draw_side_pitch(self, canvas, match, minute):
        ...
        canvas.create_text(margin+8,10,
            text=f"{match.get('home','')}  {self.lineup_formation(match,'home',minute)}",
            fill=TEXT,font=FONT_BOLD,anchor="nw")
        canvas.create_text(width-margin-8,10,
            text=f"{match.get('away','')}  {self.lineup_formation(match,'away',minute)}",
            fill=TEXT,font=FONT_BOLD,anchor="ne")
        self.draw_team_side_pitch(canvas,self.lineup_players(match,"home",minute),width,height,margin,side="left",is_home=True)
        self.draw_team_side_pitch(canvas,self.lineup_players(match,"away",minute),width,height,margin,side="right",is_home=False)

    def draw_side_penalty_box(self, canvas, width, height, margin, left_side=True):
        if left_side:
            x0,x1,six_x1 = margin,margin+140,margin+56
        else:
            x0,x1,six_x1 = width-margin-140,width-margin,width-margin-56
    ...
    def lineup_notes(self, match, minute):
        notes = [
            ...
            f"{match.get('home','')} is shown on the left and {match.get('away','')} on the right.",
            "Substitutions are highlighted with an outer ring.",
            "This pitch works with the replay slider, not as a frozen view.",
        ]
        if minute>=58: notes.append(f"{match.get('home','')} has made an attacking adjustment by this point.")
        if minute>=63: notes.append(f"{match.get('away','')} has reshaped the front line by this point.")
        return notes
    ...
    def stat_bar(self, parent, label, home, away):
        ...
        bar.grid_columnconfigure(1, weight=rw)
